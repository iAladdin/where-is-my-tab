...
- Shows short local page descriptions, with visible article/main/body text as a fallback when metadata is unavailable
...
- Upload package:
  `release/chrome-web-store/where-is-my-tab-0.3.7-chrome-web-store.zip`
- Extension icons:
